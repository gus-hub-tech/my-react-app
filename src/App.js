      ...
      <div className="preview-container">
        <div className="preview-content">
          <div className="preview-app">
            ...
            P.S. This project is part of my DevOps learning journey, proudly
            built and created by <strong>Gustav V. Kiewiets</strong> — Cloud
            Computing Specialist, AWS Certified Linux Systems Administrator &
            DevOps Engineer.

              </p>
              <p className="preview-link">
                Veiw my github projects {" "}
                <a
                  href="https://github.com/gus-hub-tech/About-Me.git"
                  target="_blank"
      ...
      <div className="simulator-content">
        ...
        <div className="simulator-footer">
          <p className="footer-content">
            🚀 <strong>My DevOps learning journey</strong> by Gustav V. Kiewiets
          </p>
